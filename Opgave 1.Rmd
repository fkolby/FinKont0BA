...
kaplt <- ggplot(paramDF, aes(x=kappahats)) +
  ...
  labs(y="Tæthed", x="Kappa est.", caption = "")+
...
thplt <- ggplot(paramDF, aes(x=thetahats)) + 
  ...
  labs(y="Tæthed", x="Theta est.", caption = "")+
...
shplt <- ggplot(paramDF, aes(x=sigmahats)) + 
  ...
  labs(y="Tæthed", x="Sigma est.", caption = "Note: Stiplet sort angiver det gennemsnitlige MLE-estimat, mens solid rød angiver den sande parameterværdi.")+
